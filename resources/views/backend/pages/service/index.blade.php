           ...
           <form role="form" action="{{route('buyer.service.update',$service->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                <input type="date" name="EndDate" class="form-control" id="date" value="{{$service->EndDate}}">
                            </div>
                            @error('EndDate')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="shortDes" id="shortdrescreption" rows="3">{{$service->shortDes}}</textarea>
                    @error('shortDes')
                    <span class="text-danger">{{$message}}</span>
                @enderror
                </div>
                <div class="form-group">
                    ...
                    <textarea class="textarea form-control" name="longdes" id="longdrescreption" rows="5" cols="7">{{$service->longdes}}</textarea>
                    @error('longdes')
                    <span class="text-danger">{{$message}}</span>
                @enderror
                </div>
        ...
        <div class="modal-content">
           ...
           <form role="form" action="{{route('buyer.service.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="date">End Date:</label>
                            <div class="input-group date">
                                <input type="date" name="EndDate" class="form-control" id="date" value={{old('EndDate')}}>
                            </div>
                            @error('EndDate')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" name="document" class="custom-file-input" id="pro_document" onchange="readURLserviceImg(this);" value={{old('document')}}>
                                    <label class="custom-file-label" for="pro_document">Choose file</label>
                                </div>
                                <div class="input-group-append">
                                    <span class="input-group-text" id="">Upload</span>
                ...
                <div class="form-group">
                    <label for="shortdrescreption">Short Drescreption</label>
                    <textarea class="form-control" name="shortDes" id="shortdrescreption" rows="3">{{old('shortDes')}}</textarea>
                    @error('shortDes')
                    <span class="text-danger">{{$message}}</span>
                @enderror
                </div>
                <div class="form-group">
                    <label for="longdrescreption">Long Drescreption</label>
                    <textarea class="textarea form-control" name="longdes" id="longdrescreption" rows="5" cols="7">{{old('longdes')}}</textarea>
                    @error('longdes')
                    <span class="text-danger">{{$message}}</span>
                @enderror
                </div>
